...
`LICENSE` files for each of the python dependencies will be included with the installation. For convenience, you can view an auto-generated table of each of the licenses and authors [here](https://github.com/jonathanfox5/gogadget/blob/main/src/gogadget/3rd-party-licenses/license_listing_for_python_dependencies.md).
